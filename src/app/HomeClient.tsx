...
export default function HomeClient({ initialTrack }: HomeClientProps) {
      ...
      <Card className="w-full border-none shadow-none max-w-3xl">
        <CardContent className="p-2 space-y-6">
            ...
            >
              <div className="space-y-4">
                <p className="text-base md:text-lg text-muted-foreground">
                  ...
                  <Highlight href="https://react.dev">React</Highlight>, and{" "}
          ...
          <div className="flex relative flex-col sm:flex-row justify-between items-center gap-4">
            <Button 
              asChild 
              className="w-2/3 rounded-lg mx-4 sm:mx-0 py-1.5 px-4 space-x-1 shadow-none bg-neutral-300 dark:bg-neutral-700 dark:text-neutral-300 hover:scale-105 duration-300 transition-all cursor-nesw-resize text-neutral-600 sm:w-auto"
            >
              <Link href="https://twitter.com/OhHarshit" className="flex items-center gap-2">
